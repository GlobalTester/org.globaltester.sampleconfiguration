...
public class FileCategoryParameterEditor extends AbstractCategoryParameterEditor{
	...
	public FileCategoryParameterEditor(Composite tabItemComp, CategoryParameterDescription curParamDescriptor) {
